...
Note that the yara-x project does not distribute binaries for all the platforms we support, the provided binaries are built manually through github actions https://github.com/DefenceTechSecurity/yara-x-dotnet-native
