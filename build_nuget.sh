...
dotnet build ./Yarax.Managed/Yarax.Managed.csproj -c Release /p:ContinuousIntegrationBuild=true 
...
dotnet build ./Yarax.Native/Yarax.Native.csproj -c Release /p:ContinuousIntegrationBuild=true 
dotnet pack ./Yarax.Native/Yarax.Native.csproj -c Release -o ./nupkgs

# Finally, build the metapackage
dotnet build ./Yarax/Yarax.csproj -c Release /p:ContinuousIntegrationBuild=true 
